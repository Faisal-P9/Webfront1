...
.to(".displayAd__devider--left", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')

.to(".displayAd__devider--right", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')
...
.to(".dynamicAd__devider--left", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')

.to(".dynamicAd__devider--right", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')
...
.to(".weboramaAd__devider--left", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')

.to(".weboramaAd__devider--right", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')
...
.to(".platform__devider--left", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')

.to(".platform__devider--right", {
  duration: 1,
  width: "48%",
}, 'clD+=0.3')
